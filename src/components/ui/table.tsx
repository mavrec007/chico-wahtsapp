...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-x-auto rounded-md sm:rounded-lg shadow">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-2 sm:px-4 py-2 sm:py-3 align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
