...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-md sm:rounded-lg border bg-card text-card-foreground shadow-sm sm:shadow-md",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex flex-col-reverse gap-2 md:flex-row md:items-center p-4 md:p-6 pt-0",
      className
    )}
    {...props}
  />
